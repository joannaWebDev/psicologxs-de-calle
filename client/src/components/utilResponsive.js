...
export const getWindowDimension = () => {
  ...
  /*a  function which derives the device type.*/
  ...
  /* the handleExceptions() function. This is a special function which is checked before the main function is run. At the moment it only detects iPad Pro as its screen size is as big as a laptop screen.*/